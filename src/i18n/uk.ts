...
export const uk = {
  ...
  attendance: {
    ...
    panel: 'Відвідуваність учня',
    globalTitle: 'Відвідуваність — всі учні',
    totalLessons: 'Всього занять',
    attended: 'Відвідано',
    missed: 'Пропущено',
    makeup: 'Відпрацювань',
    rate: 'Відвідуваність',
    overallRate: 'Загальна відвідуваність',
    totalRecords: 'Записів',
    studentsCount: 'Учнів з даними',
    byGroup: 'По групах',
    allGroups: 'Всі групи',
    allStatuses: 'Всі статуси',
    present: 'Присутній',
    absent: 'Відсутній',
    makeupPlanned: 'Відпрацювання планується',
    makeupDone: 'Відпрацьовано',
    notMarked: 'Не відмічено',
    noData: 'Даних про відвідуваність немає',
    noDataHint: 'Відвідуваність з\'явиться після того, як викладач відмітить присутність учнів на заняттях',
    noLessonsMonth: 'В цьому місяці занять немає',
    loadMore: 'Показати ще',
    lessonHistory: 'Журнал занять',
    monthlyView: 'По місяцях',
    exportCSV: 'Експорт CSV',
    sortBy: 'Сортування',
    sortName: 'За іменем',
    sortRate: 'За відвідуваністю',
    sortAbsent: 'За кількістю пропусків',
    individualLessons: 'Індивідуальні заняття',
    groupLessons: 'Групові заняття',
    register: 'Журнал групи',
    summary: 'Загальна статистика',
    selectGroup: 'Оберіть групу',
    weeklySchedule: 'Щотижневий розклад',
    outOf: 'з',
  },
  ...
  camp: {
    title: 'IT-табір',
    titlePlural: 'IT-табори',
    tabLessons: 'Заняття',
    tabCamps: 'Табори',
    newCamp: 'Новий табір',
    editCamp: 'Редагувати табір',
    nameAuto: 'Назва за сезоном',
    name: 'Назва табору',
    startDate: 'Початок',
    endDate: 'Завершення',
    season: 'Сезон',
    ...
    pricePerDayHint: 'Залиште порожнім, щоб використати глобальну ціну',
    notes: 'Примітки',
    archive: 'В архів',
    restore: 'Відновити',
    shifts: 'Зміни',
    ...
    duplicateShift: 'Дублювати зміну',
    shiftTitle: 'Назва зміни',
    shiftStart: 'Початок зміни',
    shiftEnd: 'Завершення зміни',
    shiftAutoSkipWeekends: 'Автоматично позначити Сб/Нд як вихідні',
    workingDay: 'Робочий',
    weekend: 'Вихідний',
    workingDaysCount: 'Робочих днів',
    noShifts: 'Змін ще немає',
    addFirstShift: 'Створіть першу зміну',
    participants: 'Учасники',
    participantsCount: 'Учасників',
    newParticipant: 'Додати учасника',
    fromStudents: 'З бази учнів',
    newChild: 'Нова дитина',
    selectStudent: 'Оберіть учня',
    studentAutocomplete: "Почніть вводити ім'я або телефон...",
    firstName: "Ім'я",
    lastName: 'Прізвище',
    parentName: "Ім'я батьків",
    parentPhone: 'Телефон батьків',
    selectedDays: 'Обрані дні',
    daysCount: 'Днів',
    selectAllShiftDays: 'Вся зміна',
    clearSelection: 'Очистити',
    totalExpected: 'До сплати',
    totalPaid: 'Оплачено',
    balance: 'Залишок',
    debt: 'Борг',
    ...
    convertToStudent: 'Додати в базу учнів',
    alreadyInBase: 'В базі',
    notInBase: 'Не в базі',
    payments: 'Оплати',
    ...
    method: 'Метод',
    methodCash: 'Готівка',
    methodAccount: 'Безготівково',
    paidAt: 'Дата',
    note: 'Примітка',
    noPayments: 'Оплат ще немає',
    pricePerDaySetting: 'Ціна одного дня табору',
    pricePerDaySettingHint: 'Глобальна ціна, що використовується за замовчуванням для всіх таборів',
    noCamps: 'Таборів не знайдено',
    noCampsHint: 'Створіть перший табір для літньої/зимової зміни',
    createCamp: 'Створити табір',
    confirmDeleteCamp: 'Видалити табір "{title}"? Усі зміни, учасники та оплати будуть видалені.',
    confirmDeleteShift: 'Видалити зміну "{title}"?',
    confirmDeleteParticipant: 'Видалити учасника {name}? Якщо є оплати — учасника буде позначено як скасованого.',
    confirmDeletePayment: 'Видалити цю оплату?',
    dayWarnNotWorking: 'Вибрано день, який позначено як вихідний',
  },
